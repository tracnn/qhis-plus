...
export const ERROR_409 = {
    ...
    CONFLICT_IDENTITY_NUMBER: { message: 'Số CCCD đã được đăng ký sử dụng trên hệ thống' },
    CONFLICT_INSURANCE_NUMBER: { message: 'Số BHYT đã được đăng ký sử dụng trên hệ thống' },
