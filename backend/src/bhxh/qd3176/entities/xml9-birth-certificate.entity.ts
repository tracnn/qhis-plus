...
@Entity('XML9_BIRTH_CERTIFICATE')
export class Xml9BirthCertificate extends BaseEntity {
  @Column({ name: 'XML1_ID' })
  @Index()
  xml1Id: string;
  ...
  @Column({ name: 'NGAYSINH_NND', type: 'varchar', length: 8, nullable: true })
  ngaySinhNnd: string;
  ...
  @Column({ name: 'NGAYCAP_CCCD_NND', type: 'varchar', length: 8, nullable: true })
