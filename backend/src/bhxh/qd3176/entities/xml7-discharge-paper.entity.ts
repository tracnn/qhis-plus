...
@Entity('XML7_DISCHARGE_PAPER')
export class Xml7DischargePaper extends BaseEntity {
  @Column({ name: 'XML1_ID' })
  @Index()
  xml1Id: string;
  ...
  @Column({ name: 'NGOAITRU_TUNGAY', type: 'varchar', length: 8, nullable: true })
  ngoaiTruTuNgay: string;

  @Column({ name: 'NGOAITRU_DENNGAY', type: 'varchar', length: 8, nullable: true })
