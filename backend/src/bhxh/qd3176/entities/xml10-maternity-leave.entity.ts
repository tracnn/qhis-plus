...
@Entity('XML10_NGHI_DUONG_THAI')
export class Xml10MaternityLeave extends BaseEntity {
  @Column({ name: 'XML1_ID' })
  @Index()
  xml1Id: string;
  ...
  @Column({ name: 'TU_NGAY', type: 'varchar', length: 8, nullable: true })
  tuNgay: string;

  @Column({ name: 'DEN_NGAY', type: 'varchar', length: 8, nullable: true })
  denNgay: string;
