...
@Entity('XML6_HIV_CARE_RECORD')
export class Xml6HivCareRecord extends BaseEntity {
  @Column({ name: 'XML1_ID' })
  @Index()
  xml1Id: string;
  ...
  @Column({ name: 'NGAYKD_HIV', type: 'varchar', length: 8, nullable: true })
  ngayKdHiv: string;
  ...
  @Column({ name: 'BDDTARV', type: 'varchar', length: 8, nullable: true })
  bddtArv: string;
  ...
  @Column({ name: 'NGAYBD_DTRI_LAO', type: 'varchar', length: 8, nullable: true })
  ngayBdDtriLao: string;

  @Column({ name: 'NGAYKT_DTRI_LAO', type: 'varchar', length: 8, nullable: true })
  ...
  @Column({ name: 'NGAY_XN_TLVR', type: 'varchar', length: 8, nullable: true })
  ngayXnTlvr: string;

  @Column({ name: 'KQ_XNTL_VR', type: 'int', width: 1, nullable: true })
  kqXnTlvr: number;

  @Column({ name: 'NGAY_KQ_XN_TLVR', type: 'varchar', length: 8, nullable: true })
  ngayKqXnTlvr: string;
  ...
  @Column({ name: 'NGAY_XN_PCR', type: 'varchar', length: 8, nullable: true })
  ngayXnPcr: string;

  @Column({ name: 'NGAY_KQ_XN_PCR', type: 'varchar', length: 8, nullable: true })
  ngayKqXnPcr: string;
  ...
  @Column({ name: 'NGAY_NHAN_TT_MANG_THAI', type: 'varchar', length: 8, nullable: true })
  ngayNhanTtMangThai: string;

  @Column({ name: 'NGAY_BAT_DAU_DT_CTX', type: 'varchar', length: 8, nullable: true })
  ...
  @Column({ name: 'NGAY_BAT_DAU_XU_TRI', type: 'varchar', length: 8, nullable: true })
  ngayBatDauXuTri: string;

  @Column({ name: 'NGAY_KET_THUC_XU_TRI', type: 'varchar', length: 8, nullable: true })
  ...
  @Column({ name: 'NGAY_CHUYEN_PHAC_DO', type: 'varchar', length: 8, nullable: true })
