...
export class Update1750209194154 implements MigrationInterface {
    name = 'Update1750209194154'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_e90ee356ae068cd215411346ef" ON "APPOINTMENT_SLOTS" ("SLOT_DATE", "SLOT_TIME", "IS_ACTIVE")`);
        await queryRunner.query(`CREATE INDEX "IDX_25a9b2c18282e7ecf8ba2361df" ON "APPOINTMENT_SLOTS" ("DOCTOR_ID", "IS_ACTIVE")`);
        await queryRunner.query(`CREATE INDEX "IDX_28071f7262c2af19e6f5736de7" ON "APPOINTMENT_SLOTS" ("CLINIC_ID", "IS_ACTIVE")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "IDX_28071f7262c2af19e6f5736de7"`);
        await queryRunner.query(`DROP INDEX "IDX_25a9b2c18282e7ecf8ba2361df"`);
        await queryRunner.query(`DROP INDEX "IDX_e90ee356ae068cd215411346ef"`);
